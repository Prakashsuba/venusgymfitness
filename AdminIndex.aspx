<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminIndex.aspx.cs" Inherits="VenusGym.AdminIndex" %>
              ...
              <div class=" d-flex flex-column flex-lg-row align-items-center">
                <ul class="navbar-nav ">
                  <li class="nav-item active">
                      <a class="nav-link" runat="server" href="Login.aspx" title="Manage your account" id="A2" style="font-weight: bold ">Hello!,<%: Session["UserName"] %>!</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="StaffReports.aspx">StaffReports</a>
                  </li> 
                    <li class="nav-item">
                    <a class="nav-link" href="MembersDetails.aspx">GymMembersReports</a>
                  </li>
                    <li class="nav-item">
                    <a class="nav-link" href="FeebackReports.aspx">FeedbacksDeatils</a>
                  </li>
                  
                    <li class="nav-item">
                    <a class="nav-link" runat="server" href="Admin.aspx" id="A1" style="font-weight: bold">Logout</a>
                  </li>
                </ul>
