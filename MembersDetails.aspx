<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MembersDetails.aspx.cs" Inherits="VenusGym.MembersDetails" %>
                ...
                <ul class="navbar-nav  ">
                  <li class="nav-item">
                   ...
                   <li> <a runat="server" href="#" title="Manage your account" id="lnkWelcome" style="font-weight: bold">Hello!! Admin</a></li>
                    ...
                    <a class="nav-link" href="MembersDetails.aspx">MembersReports</a>
                  </li>
                    <li class="nav-item">
                    <a class="nav-link" href="SearchUpdateMember.aspx">MembersUpdate/SearchDetails</a>
                  </li>
                    <li class="nav-item">
                    <a class="nav-link" href="PaymentsDetails.aspx">PaymentsGymMember</a>
                  </li>
                    <li class="nav-item">
