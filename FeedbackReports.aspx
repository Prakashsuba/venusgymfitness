<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FeedbackReports.aspx.cs" Inherits="VenusGym.FeedbackReports" %>
              ...
              <div class="d-flex  flex-column flex-lg-row align-items-center">
                <ul class="navbar-nav  ">
                  ...
                  <li class="nav-item active">
                    <a class="nav-link" href="FeebackReports.aspx">FeebackReports</a>
                  </li>
                    <li class="nav-item">
            ...
            <form action="" runat="server" >
              <div class="contact_form-container">
                <div class="row"> 
                    ...
                    <div class="col-md-12">
                        <asp:GridView ID="GridView_Feedbackreports" runat="server" Height="58px" Width="802px"></asp:GridView>
                    </div>
                    <div class= "col-xs-6 col-sm-6 col-md-12 text-center">
                      <asp:Button ID="btn_Back" CssClass="btn btn-danger" runat="server" Text="Back"  Width="334px" OnClick="btn_Back_Click" Height="30px"  /><br>
                  </div>
                </div>
              </div>
            </form>
